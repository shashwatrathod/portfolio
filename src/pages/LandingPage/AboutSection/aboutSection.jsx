          ...
          <div className="about-main-grid">
            ...
            <div className="about-content-container">
              ...
              <p>
                ...
                currently pursuing MS in <strong>Computer Science</strong> from
                Northeastern University in Boston, USA. I have been passionate
                about tech ever since I got my first smartphone back in 2015
                which I rooted (and consequently, bricked :/).
              </p>
              <p>
                ...
                <strong>Embedded Systems</strong> into small and big projects I
                undertook over the years individually as well as in a team. I
                find my predilection towards Software Dev rather special though.
              ...
              <p>
                ...
                documentries about the universe and aviation.
              </p>
            </div>
          </div>
        </div>
